        ...
        {(!Array.isArray(projects) || projects.length === 0) ? (
          ...
          <div className="projects-summary">
            {projects.map((project, projectIndex) => {
              ...
              return (
                <div key={project.id || `project-${projectIndex}`} className="project-summary-card">
                    ...
                    {projectTasks.length === 0 ? (
                      ...
                      <div className="task-summary">
                        ...
                        <div className="recent-tasks">
                          {projectTasks.slice(0, 3).map((task, taskIndex) => (
                            <div key={task.id || `task-${taskIndex}`} className="task-item-mini">
        ...
        {(!Array.isArray(tasks) || tasks.length === 0) ? (
          ...
          <div className="activity-list">
            {tasks.slice(0, 5).map((task, index) => (
              <div key={task.id || `activity-${index}`} className="activity-item">
